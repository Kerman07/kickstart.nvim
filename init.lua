...
vim.keymap.set('n', '<leader>s1', function() vim.cmd 'edit ~/.scratch/1.rb' end, { desc = 'Scratch 1' })
vim.keymap.set('n', '<leader>s2', function() vim.cmd 'edit ~/.scratch/2.rb' end, { desc = 'Scratch 2' })
vim.keymap.set({ 'n', 'v' }, '}', '<C-d>zz')
vim.keymap.set({ 'n', 'v' }, '{', '<C-u>zz')
...

  {
    ...
    config = function()
      require('rose-pine').setup {
        variant = 'dawn', -- 'main' (dark), 'moon' (dark), 'dawn' (light)
        styles = {
          italic = false,
        },
      }
